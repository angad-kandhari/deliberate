...
Drop this file into any project. Reference it from `CLAUDE.md`, `.cursorrules`, or load it directly. Pairs with the specialized skills in `skills/` for spec work, debugging, review, testing, verification, security, codebase exploration, architecture, migrations, and incidents.
